...
# ``mlops_databricks_azure_devops/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-mlops-databricks-azure-devops-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained model.
dbutils.widgets.text(
    "model_name", "dev.mlops_model_schema.mlops-databricks-azure-devops-model", label="Full (Three-Level) Model Name"
)
