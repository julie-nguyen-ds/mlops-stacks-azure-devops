...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``mlops_databricks_azure_devops/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in mlops-databricks-azure-devops/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in mlops-databricks-azure-devops/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-mlops-databricks-azure-devops-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.mlops_model_schema.mlops-databricks-azure-devops-model", "Full (Three-Level) Model Name")
