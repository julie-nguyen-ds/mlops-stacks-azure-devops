...
Opening a pull request will trigger a[Azure DevOps Pipeline](../.azure/devops-pipelines/mlops-databricks-azure-devops-tests-ci.yml) 
...
* [Staging model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/staging/mlops-databricks-azure-devops/mlops-databricks-azure-devops-model)
* [Prod model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/prod/mlops-databricks-azure-devops/mlops-databricks-azure-devops-model)
. 
